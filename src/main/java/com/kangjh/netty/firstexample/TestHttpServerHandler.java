package com.kangjh.netty.firstexample;
...
//	}
	...
	@Override
	public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {//2
		System.out.println("channel registered");
	...
	@Override
	public void channelUnregistered(ChannelHandlerContext ctx) throws Exception {//4
